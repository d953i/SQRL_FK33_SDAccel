...
set_property -dict [list CONFIG.NUM_SI {2} CONFIG.NUM_MI {3}] [get_bd_cells axi2pr]
...
connect_bd_net [get_bd_pins xdma/axi_aresetn] [get_bd_pins axi2pr/ARESETN]
connect_bd_net [get_bd_pins xdma/axi_aresetn] [get_bd_pins axi2pr/S00_ARESETN]
connect_bd_net [get_bd_pins xdma/axi_aresetn] [get_bd_pins axi2pr/M00_ARESETN]
connect_bd_net [get_bd_pins xdma/axi_aresetn] [get_bd_pins axi2pr/M01_ARESETN]
connect_bd_net [get_bd_pins xdma/axi_aresetn] [get_bd_pins axi2pr/S01_ARESETN]
connect_bd_net [get_bd_pins xdma/axi_aresetn] [get_bd_pins ocl_block/ARESET]
connect_bd_net [get_bd_pins xdma/axi_aresetn] [get_bd_pins pr2axi/ARESETN]
connect_bd_net [get_bd_pins xdma/axi_aresetn] [get_bd_pins pr2axi/S00_ARESETN]
connect_bd_net [get_bd_pins xdma/axi_aresetn] [get_bd_pins pr2axi/M00_ARESETN]
connect_bd_net [get_bd_pins xdma/axi_aresetn] [get_bd_pins pr2axi/S01_ARESETN]
...
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi2pr/M02_ACLK]
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_apb_bridge_0/s_axi_aclk]
...
connect_bd_net [get_bd_pins sys_reset/peripheral_aresetn] [get_bd_pins axi2pr/M02_ARESETN]
connect_bd_net [get_bd_pins sys_reset/peripheral_aresetn] [get_bd_pins axi_apb_bridge_0/s_axi_aresetn]
...
connect_bd_net [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins xdma/axi_aresetn]
connect_bd_net [get_bd_pins pr2axi/M01_ACLK] [get_bd_pins xdma/axi_aclk]
connect_bd_net [get_bd_pins pr2axi/M01_ARESETN] [get_bd_pins xdma/axi_aresetn]
